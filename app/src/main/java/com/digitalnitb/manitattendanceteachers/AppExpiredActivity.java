...
public class AppExpiredActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference().child("ManitAttendanceTeacher.apk");
        ...
        btnDownloadGdrive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(isOnline()){
                    ...
                    mLoadingProgress.setCanceledOnTouchOutside(false);
                    mLoadingProgress.show();
                    FirebaseDatabase.getInstance().getReference().child("APP-VERSION").child("DriveTeacher").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            String url = dataSnapshot.getValue().toString();
                            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
                            Intent browserChooserIntent = Intent.createChooser(browserIntent , "Download Manit Attendance Teacher");
    ...
    private class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                OutputStream output = new FileOutputStream(Environment.getExternalStorageDirectory() + "/download/" + "ManitAttendanceTeacher.apk");
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            try {
                File toInstall = new File(Environment.getExternalStorageDirectory() + "/download/" + "ManitAttendanceTeacher.apk");
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    Uri apkUri = FileProvider.getUriForFile(AppExpiredActivity.this, BuildConfig.APPLICATION_ID + ".provider", toInstall);
                    ...
                    Toast.makeText(AppExpiredActivity.this, "Unable to start installer, please follow above instructions", Toast.LENGTH_LONG).show();
                }
